	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 texCoord65 = input.ase_texcoord1.xyz;
				texCoord65.xy = input.ase_texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult90 = (float2(texCoord65.x , texCoord65.y));
				float2 appendResult69 = (float2(( 0.25 * texCoord65.z * _AnimationFadeSpeed ) , 0.0));
				float2 appendResult76 = (float2(_AnimationFadeOffset , 0.0));
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;99;-4284,1102;Inherit;False;3132.256;561.4174;;19;89;156;160;92;39;84;79;78;77;72;76;75;32;70;69;90;81;65;71;Opacity;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;154;-3072,2432;Inherit;False;Max Render Distance;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;156;-2176,1472;Inherit;False;154;Max Render Distance;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;89;-2176,1568;Inherit;False;Property;_OpacityIntensity;Opacity Intensity;0;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;101;-560,336;Inherit;False;563;302.9999;;4;136;135;94;64;Output;1,0,0,1;0;0
...
ASEEND*/
//CHKSM=93006B62C1B13F5735C7A15F2A82595C7C23A1E8