	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float screenDepth102 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth102 = abs( ( screenDepth102 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( _GeometryDepthFadeDistance ) );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_Opacity103 = input.ase_texcoord1.xy;
				float VColor_Alpha131 = input.ase_color.a;
				float screenDepth102 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth102 = abs( ( screenDepth102 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( _GeometryDepthFadeDistance ) );
				float clampResult109 = clamp( distanceDepth102 , 0.0 , 1.0 );
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;101;-2352,208;Inherit;False;814;302;;13;140;154;148;147;146;145;144;143;142;141;139;64;94;Output;1,0,0,1;0;0
...
ASEEND*/
//CHKSM=841777456303BCFCFEAE90E7617C861C65810FD3